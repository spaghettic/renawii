...
- `config/[GAMEID]` - Configuration files for each game version. ;Random proto unlikely but who knows, Eng build could be done though
...
- `orig/[GAMEID]` - Original game files, extracted from the disc. Ignored by `.gitignore`. ;Looks like it's R4YJ
...
- `README.md` - This file, replace with your own. For a template, see [`README.example.md`](README.example.md). ;We'll edit everything over time
